    ...
    return (
        <Layout status="logging">
            <div className='h100 flex flex-col items-center'>
                ...
                <Input fatherClass="flex flex-col items-center mt-6" className="fs-18 lh-23 br-none bx-sh-2 br-ra-100 c-grey h-4 w-38 ph-4" placeholder='name@mail.domain' label="Цахим хаяг" id="gmail" labelClassName="font-ubuntu fs-18 lh-23 c-grey h-4 w-38 pa-2" />
